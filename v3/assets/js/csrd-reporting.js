...
(function () {
  ...
  window.csrdShowcase = function () {
    return {
      active: 0,
      slides: ["/assets/img/photos/csrd/dashboard/csrd-dashboard-01.webp", "/assets/img/photos/csrd/dashboard/csrd-dashboard-02.webp", "/assets/img/photos/csrd/dashboard/csrd-dashboard-03.webp", "/assets/img/photos/csrd/dashboard/csrd-dashboard-04.webp", "/assets/img/photos/csrd/dashboard/csrd-dashboard-05.webp"],
      timer: null,
      intervalMs: 4500,
      get count() {
  ...
  function initResourcesCarousel() {
    var track = document.getElementById("csrd-resources-track");
    if (!track) return;
    ...
    function updateArrowStates() {
      ...
      document.querySelectorAll("[data-csrd-resources-prev]").forEach(function (btn) {
        btn.disabled = atStart;
      });
      document.querySelectorAll("[data-csrd-resources-next]").forEach(function (btn) {
        btn.disabled = atEnd;
      });
    }

    function scrollBy(direction) {
      var slide = track.querySelector(".csrd-resource-slide");
      var gap = 16;
